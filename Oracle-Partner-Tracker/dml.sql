...
FROM company c
         ...
         JOIN service_expertise e ON ce.expertise_id = e.id
         JOIN expertise_certification ec ON e.id = ec.expertise_id
         JOIN certification cert ON ec.certification_id = cert.id
         LEFT JOIN user_certification uc ON uc.certification_id = cert.id
